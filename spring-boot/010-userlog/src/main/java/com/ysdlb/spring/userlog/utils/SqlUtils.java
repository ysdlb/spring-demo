package com.ysdlb.spring.userlog.utils;
...
public class SqlUtils {
    ...
    public static String getMybatisSql(ProceedingJoinPoint pjp, SqlSessionFactory sqlSessionFactory) throws IllegalAccessException {
        ...
        System.out.println("=========namespace: " + namespace + " methodname: " + methodName);
        System.out.println("=================configration: " + configuration.getDatabaseId());
